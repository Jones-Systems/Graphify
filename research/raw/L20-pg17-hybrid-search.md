...
> **Evidence boundary:** the reviewed file exposed private, live deployment
> details that are not committed in this repository. Those details have been
> removed. The comparison below retains only public-source material. Whether
> any PostgreSQL service exists, is suitable, or may host this workload remains
> unknown and requires separate current evidence and authority.
